...
class Data {
    constructor() {
        ...
        this.block = new Block(0, canvas.height - 200, canvas.width / 4, 50, 'red', 'normal');

        this.block2 = new Block(canvas.width - canvas.width / 4, canvas.height - 200, canvas.width / 4, 50, 'blue', 'normal');
